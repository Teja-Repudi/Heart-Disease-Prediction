...
function Navbar() {
  ...
  const navItems = [
    { path: '/', label: 'Home' },
    { path: '/learning', label: 'Control', protected: true },
    { path: '/analysis', label: 'User', protected: true },
    { path: '/risk-and-symptoms', label: 'Admin', protected: true },
    { path: '/food-recommendations', label: 'Health Guide', protected: true },
    { path: '/stories', label: 'XAi Features', protected: true }
  ];
        ...
        <div className="flex justify-between h-16">
          <Link to="/" className="flex items-center space-x-3">
            ...
            >
              ...
              <span className="text-xs text-red-500 font-medium">KNOW YOUR RISK</span>
            </motion.div>
          </Link>
